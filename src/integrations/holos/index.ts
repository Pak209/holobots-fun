...
export const HOLOS_CONTRACTS = {
  ...
  HOLOS_TOKEN: process.env.VITE_HOLOS_TOKEN_ADDRESS || '',
  RENTAL_CONVERSION_MANAGER: process.env.VITE_RENTAL_CONVERSION_MANAGER_ADDRESS || '',
  TREASURY: process.env.VITE_TREASURY_ADDRESS || '',
  STOCKPILE: process.env.VITE_STOCKPILE_ADDRESS || '',
  GENESIS_NFT_MINTER: process.env.VITE_GENESIS_NFT_MINTER_ADDRESS || '',
  SEASON1_NFT: process.env.VITE_SEASON1_NFT_ADDRESS || '',
} as const;
