...
// Daily boss rotation function - UPDATED to use actual holobots from HOLOBOT_STATS
export const getDailyBossRotation = () => {
  ...
  // Get all available holobots from HOLOBOT_STATS
  const availableHolobots = Object.keys(HOLOBOT_STATS).filter(key => 
    key !== 'MAX_LEVEL' && 
    key !== 'BASE_HEALTH' && 
    key !== 'BASE_ATTACK' && 
    key !== 'BASE_DEFENSE' && 
